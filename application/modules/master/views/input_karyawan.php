                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input value="<?php echo @$paramedik->email; ?>" type="text" id="email" name="email" class="form-control" placeholder="alamat email">
                        </div>
                    </div>
                    <!--/span-->
                </div>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input required value="<?php echo @$paramedik->bonus; ?>" type="text" id="bonus" name="bonus" class="form-control" placeholder="Bonus" onKeyPress="return goodchars(event,'1234567890',this)">
                                <span class="input-group-addon">Rp.</span>
                            </div>
                        </div>
                    </div> -->
