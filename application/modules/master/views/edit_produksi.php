     ...
     <div class="form-body">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    $get = $this->db->query("SELECT * FROM produksi where id='$id'");
                    $hasil = $get->row();
                    $id_menu = $hasil->id_product;
                    $get_produk = $this->db->query("SELECT * FROM menu where id='$id_menu'");
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                       ...
                       <select class="form-control select2" required name="produk" data-placeholder="Pilih Kategori" required>
                        ...
                        $get_menu = $this->db->get('view_menu');
                        $hasil_get = $get_menu->result_array();

                        foreach ($hasil_get as $item) {
                         ?>                

                         <option <?php if ($item['id'] == $hasil_produk->id){echo'selected="true"';} ?> value="<?php echo $item['id'];?>" ><?php echo $item['nama'];?></option>
                     ...
                     <div class="form-group">
                       ...
                       <input value="<?php echo   $hasil->jumlah_produksi ?>" type="number" required id="min" name="jumlah" class="form-control" placeholder="jumlah produksi">
                     </div>
                   </div>
                 </div>
               </div>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      $('#form-add').submit(function(){
       $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'master/produksi/simpan_ubah' ?>",  
        cache :false,  
        data :$(this).serialize(),
