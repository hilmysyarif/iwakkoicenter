    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Daftar Gudang</div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span style="font-weight:bold; font-size:14pt">Apakah anda yakin akan menghapus data Gudang tersebut ?</span>
...
$(function(){
    ...
    */
    var oTable = $('#example-datatable').dataTable( {
        ...
        "bProcessing":true,
        "bServerSide":true,
        "sAjaxSource": "<?php echo base_url($this->module); ?>/_datatable/rak",
...
function delData(){
    ...
    var url = '<?php echo base_url($this->cname); ?>/delete_kategori';
    $.ajax({
        type: "POST",
        url: url,
        data: {id:id},
