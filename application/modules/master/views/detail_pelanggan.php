<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->cname); ?>">Pelanggan</a><i class="icon-angle-right"></i></li>
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Detail Pelanggan</div>
        <!-- <div class="actions">
                ...
                <div class="row">
                   ...
                   <!--  <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <p class="form-control-static"><?php echo tanggalIndo(@$paramedik->expired); ?></p>
                            </div>
                        </div>
                    </div> -->
                    <!--/span-->
