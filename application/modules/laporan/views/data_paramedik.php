    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Daftar Paramedik</div>
            </div>
            <div class="portlet-body form">
                <span id="flash_message"></span>
                <form id="form_gaji" class="horizontal-form" method="POST" action="<?php echo base_url($this->cname); ?>/pdf_paramedik" target="_blank">
                    <div class="form-body">
                        <h3 class="form-section">Data Paramedik</h3>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">Paramedik</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="operator" id="operator" class=" form-control">
                                        ...
                                        <?php foreach ($cust_name as $key => $value) {
                                        ?>
...
function list_Kasir(){
    ...
    var url = "<?php echo base_url($this->cname);?>/table_param";
