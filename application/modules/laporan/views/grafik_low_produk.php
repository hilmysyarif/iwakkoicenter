    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Low Produk</div>
            </div>
            <div class="portlet-body">
                <span id="flash_message"></span>
                <form id="form_low" class="horizontal-form">
                    <div class="form-body">
                        <h3 class="form-section">Grafik Low Produk</h3>
                        <div class="row">
                            <div class="col-md-2">
...
<script type="text/javascript">
        ...
        $('#form_low').submit(function(){
           var url = "<?php echo base_url($this->cname); ?>/grafik_low_produk";
           $.ajax({
              type: "POST",
              url: url,
              data: $('#form_low').serialize(),
