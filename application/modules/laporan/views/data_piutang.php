    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Daftar Piutang</div>
            </div>
            <div class="portlet-body form">
                <span id="flash_message"></span>
                <form id="form_gaji" class="horizontal-form" method="POST" action="<?php echo base_url($this->cname); ?>/pdf_piutang" target="_blank">
                    <div class="form-body">
                        <h3 class="form-section">Data Daftar Piutang</h3>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="rak" id="rak" class="select2me form-control">
                                        ...
                                        ?>
                                        <option value="<?php echo $value->person;?>"><?php echo $value->name;?></option>
                                       <?php }?>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function list_stock(){
        ...
        //var produk = $('#name').val();
        var url = "<?php echo base_url($this->cname);?>/table_piutang";
        $.ajax({
            type: "POST",
            url: url,
            data: {sup:rak},
