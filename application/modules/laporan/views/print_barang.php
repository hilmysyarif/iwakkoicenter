...
$this->thoni_fpdf->Cell(27,1,'Atombizz',0,0,'R');
$this->thoni_fpdf->Ln(0.4);
$this->thoni_fpdf->SetFont('helvetica','',10);
...
$this->thoni_fpdf->Line(1,2.8,28,2.8);
$this->thoni_fpdf->Line(1,2.85,28,2.85);
...
$this->thoni_fpdf->SetWidths(array(1, 3, 3, 3, 10, 2, 5));
$this->thoni_fpdf->SetAligns(array('C','C','C','C','C','C','C'));
$this->thoni_fpdf->Row(array('No.', 'Kode Produk', 'Nama Produk','Tanggal', 'Keterangan', 'Qty','Operator'));
$no = 1;
$i = 0;
$total = 0;
...
foreach ($data as $key => $value) {
   ...
   $this->thoni_fpdf->Row(array($no, $value->product_code, $value->product_name, $value->date,$value->description,$value->quantity,$value->operator));
