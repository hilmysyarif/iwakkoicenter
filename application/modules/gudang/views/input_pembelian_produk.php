 ...
 <div class="col-md-12">
  <div class="portlet box green">
   <div class="portlet-title">
    <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Pembelian Produk</div>
  </div>
       ...
       <div class="row">
         ...
         <div class="col-md-6">
          <div class="form-group">
           ...
           <select class="form-control select2" id="produk" required name="produk" data-placeholder="Pilih Kategori" required>
         ...
         <div class="form-group">
           <label class="control-label">Jumlah Produk <span style="text-weight:bold" id="show_min_satuan"></span></label>
...
<script type="text/javascript">
 $(document).ready(function(){
   ...
   $('#min').keyup(function(event) {
     $.ajax( {  
      type :"post",  
      url : "<?php echo base_url() . 'gudang/pembelian/get_total_biaya' ?>",  
      cache :false,  
       data :({key:$('#produk').val(),jumlah:$(this).val()}),
      success : function(data) {  
        $("#total_biaya").html(data);           
      },  
    });
     return false;       
   })
   ...
   $('#form-add').submit(function(){
     $.ajax( {  
      type :"post",  
      url : "<?php echo base_url() . 'gudang/pembelian/simpan_pembelian_produk' ?>",  
      cache :false,  
      data :$(this).serialize(),
      success : function(data) {  
        $(".sukses").html(data);   
        setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'gudang/pembelian/data' ?>";},500);              
      },  
      error : function() {  
