...
<div class="row">
    <div class="col-md-12">
        <div class="tiles" style="padding:10px; margin-right:0px; height:155px">
    ...
    <div class="col-md-12">
        ...
        <div id="add_produk" class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Transaksi Pembelian Bahan</div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required value="<?php echo date('Y-m-d'); ?>" type="date" id="input_tanggal" name="input_tanggal" class="date-picker form-control" data-date-format="yyyy-mm-dd" readonly>                            
                                </div>
                            </div>
                        </div>
                    </div>
