...
class Accounting extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('mdl_accounting','mp');
        $this->module='finance';
        $this->cname=$this->module.'/accounting';
    ...
    public function data()
    {
        ...
        $data['title']='Keuangan - Data Transaksi';
        $data['content'] = $this->load->view('/data_accounting',$data,TRUE);
    ...
    public function daftar_transaksi()
    {
        ...
        $this->datatables->select('id,tanggal,no_referensi,akun_name,keterangan,debit')
    ...
    public function tambah()
    {
        ...
        // $data['count'] = format_number($this->mp->count_data());
        $data['sidebar_active']='keuangan';
        $data['title']='Keuangan - Tambah Transaksi';
        $data['content'] = $this->load->view('/input_accounting',$data,TRUE);
        $this->load->view('template',$data);
    }
