...
function cekTemp(){
    ...
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/cek_temp_retur_in";
    $.ajax({
        type: "POST",
        url: url,
...
function actEdit(Object){
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/detail_retur_in";
    var form_data = {
        id: Object
    };
    $.ajax({
...
function res_total(){
    ...
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/total_nominal";
    $.ajax({
        type: "POST",
        url: url,
        data: {total:total},
...
function listProduk(){
    ...
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/list_produk";
    var form_data = {
        reference:reference
    };
    $.ajax({
...
function prosesPembelian(){
    ...
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/proses_retur_in";
    var form_data = {
...
function begin(){
    var url = "<?php echo base_url(); ?>stok_produk/retur_internal/faktur_distribusi";
    $.ajax({
        type: "POST",
        url: url,
        success: function(msg)
...
$(document).ready(function(){
    ...
    $('#formAdd').submit(function(){
        ...
        var url = "<?php echo base_url(); ?>stok_produk/retur_internal/retur_in_produk";
        var form_data = {
            ident: ident,
            reference: reference_no,
            date: date,
