...
class Opname extends ASTRO_Controller {
	...
	public function index()
	{
		...
		$data['title'] = "Menu Opname | stok_produk";
	...
	public function print_product()
	{
		...
		$data['title'] = "Print Opname | stok_produk";
  ...
  //     	// generate to excel
	...
	public function stok($value='')
	{
		...
		$data['sidebar_active'] = 'stok_produk';
		$data['keyword'] = $this->mak->opt_keyword();
		$data['title'] = "Stok Opname | stok_produk";
...
/* Location: ./application/modules/stok_produk/controllers/opname.php */