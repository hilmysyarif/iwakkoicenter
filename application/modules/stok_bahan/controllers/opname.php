...
class Opname extends ASTRO_Controller {
	...
	public function index()
	{
		...
		$data['title'] = "Menu Opname | stok_bahan";
	...
	public function print_product()
	{
		...
		$data['title'] = "Print Opname | stok_bahan";
  ...
  //     	// generate to excel
	...
	public function stok($value='')
	{
		...
		$data['sidebar_active'] = 'stok_bahan';
		$data['keyword'] = $this->mak->opt_keyword();
		$data['title'] = "Stok Opname | stok_bahan";
...
/* Location: ./application/modules/stok_bahan/controllers/opname.php */