...
class Spoil extends MY_Controller {
    ...
    public function detail($id){
        ...
        $data['sidebar_active']='stok_bahan';
        $data['title']='stok_bahan - Detail Spoil';
        // print_r($param);exit;
    ...
    public function mencari()
    {
        ...
        echo json_encode($das).'|'.$this->mp->_opt_satuan($das->unit);
    }
                ...
                if($save_beli == TRUE){
                    ...
                    if($delete>0){
                        ...
                        $jurnal = array(
                            ...
                            'tanggal'=>$param['tgl'],
                            'keterangan'=>'Spoil stok stok_bahan dengan referensi '.$reference,
                            'no_akun'=>'130000',
                            'debit'=>0,
