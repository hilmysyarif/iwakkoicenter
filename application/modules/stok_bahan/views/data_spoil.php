<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->module); ?>">Stok Bahan</a><i class="icon-angle-right"></i></li>
            <li><a href="<?php echo base_url($this->cname); ?>">Spoil</a><i class="icon-angle-right"></i></li>
            <li><a href="#">Daftar Spoil</a></li>
            <li class="pull-right">
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Daftar Spoil - Bahan</div>
            </div>
...
<script type="text/javascript">
   $(function(){
        ...
        var oTable = $('#example-datatable').dataTable( {
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource": "<?php echo base_url($this->module); ?>/_datatable/daftar_spoil",
