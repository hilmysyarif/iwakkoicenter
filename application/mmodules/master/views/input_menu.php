<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->cname); ?>">Menu</a><i class="icon-angle-right"></i></li>
...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Tambah Menu</div>
    </div>
    <div class="portlet-body form">
        <div class="form-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" class="form-control" placeholder="Kode Menu" autocomplete='off'>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Menu">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <button onclick="addBahan()" class="btn btn-small blue" style="margin-top:27px"><i class="icon-remove"></i> ADD</button>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label class="control-label"></label>
                        <button onclick="addMixBahan()" class="btn btn-small blue" style="margin-top:27px"><i class="icon-remove"></i> ADD</button>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Komposisi Menu</div>
            </div>
...
function actListEdit(argument) {
    var url = "<?php echo base_url($this->cname) ?>/detail_bahan_mix";
    $.ajax({
        type: 'POST',
        url: url,
        data: {
        ...
        success: function(msg){
            ...
            data = JSON.parse(msg);
            $('#ident').val(data.id);
            $('#barcode_product').val(data.barcode_product);
            $('#barcode_product').select2().trigger('change');
            $('#qty_product').val(data.qty_product);
...
function list_mix(){
    ...
    if(code){
        ...
        alertify.alert('Silahkan isi data menu terlebih dahulu.');
    }
    return false;
}
