                ...
                <table class="table table-striped table-bordered table-hover" id="example-datatable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" width="150px">Kode Suplier</th>
                            <th class="text-center" width="px">Nama Suplier</th>
...
$(function(){
    ...
    */
    var oTable = $('#example-datatable').dataTable( {
        ...
        "bProcessing":true,
        "bServerSide":true,
        "sAjaxSource": "<?php echo base_url($this->module); ?>/hutang/daftar_hutang",
