...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->cname); ?>/tambah">Tambah Transaksi</a></li>
            <li class="pull-right">
    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Transaksional Biaya</div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="KAS" id="kode" name="kode" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Pengeluaran Sebesar</label>
