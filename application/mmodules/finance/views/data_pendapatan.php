<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
        Daftar Pendapatan Non ransaksi
        </h3>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Daftar Pendapatan Non Transaksi</div>
            </div>
...
$(function(){
    ...
    */
    var oTable = $('#example-datatable').dataTable( {
        ...
        "bProcessing":true,
        "bServerSide":true,
        "sAjaxSource": "<?php echo base_url($this->module); ?>/pendapatan/daftar_transaksi",
        "fnServerData": function(sSource, aoData, fnCallback){
            aoData.push({name:"filter",value:"PD"});
            $.ajax(
            {
                'dataType': 'json',
                'type'  : 'POST',
