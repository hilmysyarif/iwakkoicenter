...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->module); ?>/payroll">Hutang</a><i class="icon-angle-right"></i></li>
            <!-- <li><a href="<?php echo base_url($this->cname); ?>">Menu Kasbon</a><i class="icon-angle-right"></i></li> -->
            <li><a href="<?php echo base_url($this->cname); ?>/tambah">Catat Hutang</a></li>
            <li class="pull-right">
    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-plus-sign"></i>&nbsp;Catat</div>
            </div>
            <div class="portlet-body form">
                ...
                <form id="form-add" class="horizontal-form">
                    <div class="form-body">
                        <h3 class="form-section">Catat Hutang</h3>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Tanggal Hutang</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="<?php echo date('Y-m-d',strtotime('+1 months')); ?>" id="jatuh_tempo" name="jatuh_tempo" class="date-picker form-control" placeholder="Tanggal Jatuh Tempo" data-date-format="yyyy-mm-dd">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    $('#form-add').submit(function() {
        var url = '<?php echo base_url($this->cname); ?>/input_hutang';
        $.ajax({
            type: "POST",
            url: url,
