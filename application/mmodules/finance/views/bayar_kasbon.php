...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->cname); ?>/tambah">Kasbon</a></li>
            <li class="pull-right">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <form id="form-add" class="horizontal-form">
                    <div class="form-body">
                        <h3 class="form-section">Bayar Kasbon <span class="pull-right">Kasbon Belum Terbayar:: <span id="sisa" style="font-weight:bold">Rp. 0,00</span></span></h3>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Referensi No</label>
                                    <input type="hidden" value="KASBON" id="kode" name="kode" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Tanggal Kasbon</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo form_dropdown('karyawan', $karyawan, @$opt, 'id="karyawan" class="form-control select2me" data-placeholder="Pilih Nama Karyawan"'); ?>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Jumlah Pembayaran Kasbon</label>
...
$(document).ready(function() {
    ...
    $('#form-add').submit(function() {
        var url = '<?php echo base_url($this->cname); ?>/input_kasbon_bayar';
        $.ajax({
            type: "POST",
            url: url,
