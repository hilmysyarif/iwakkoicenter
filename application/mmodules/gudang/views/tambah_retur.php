...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="<?php echo base_url($this->cname); ?>">Retur Pusat</a><i class="icon-angle-right"></i></li>
            <li><a href="">Retur Pusat</a></li>
            <li class="pull-right">
    ...
    <div class="col-md-12">
        ...
        <div id="product_form" class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-shopping-cart"></i>&nbsp;Transaksi Retur Pusat</div>
            </div>
            <div class="portlet-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="note note-info">
                            <span style="font-weight:bold;"><i class="icon-file-text"></i>&nbsp;&nbsp;&nbsp;Ke</span>
                            <span id="supplier_name" class="pull-right">Pusat</span>
                            <span id="user_id" style="display:none"><?php echo $user[0]->uname; ?></span>
                            <span id="supplier_code" style="display:none">pusat</span>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color:grey">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title" style="color:#fff;">Retur Ke</h4>
            </div>
                        ...
                        <div id="edit_hide" class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">Pemasok Bahan</label>
