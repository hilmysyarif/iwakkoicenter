                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="padding-left:0px;">
                        <div class="bg-blue" style="height:80px; padding: 20px 10px 0px 10px; margin-bottom:5px">
                            ...
                            <i class="icon-file" style="font-size:54px; margin-top:5px"></i>
                            <p>KODE SPOIL</p>
                        </div>
                        <div class="bg-blue" style="height:80px; padding: 20px 10px 0px 10px; margin-bottom:5px">
                            ...
                            <i class="icon-calendar" style="font-size:54px; margin-top:5px"></i>
                            <p>TANGGAL</p>
                        </div>
                    </div>
                </div>
...
function begin(){
    var url = "<?php echo base_url(); ?>gudang/spoil/faktur_spoil";
    $.ajax({
        type: "POST",
        url: url,
        success: function(msg)
