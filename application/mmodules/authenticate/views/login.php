...
<body class="login">
   <!-- BEGIN LOGO -->
   <div class="logo" style="margin-bottom:30px; margin-top:15%">
      <img src="<?php echo base_url(); ?>public/img/bg/atom.png" alt="" />
   </div>
   <!-- END LOGO -->
   <!-- BEGIN LOGIN -->
   <div class="content">
      ...
      <form class="login-form" action="<?php echo base_url($this->cname).'/login'; ?>" method="post">
         <h3 class="form-title" style="padding-left:50px; margin-bottom:30px; font-weight:bold"></h3>
