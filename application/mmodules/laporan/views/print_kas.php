...
$this->thoni_fpdf->Cell(28,0.5,'DAFTAR KAS PERIODE '.tanggalIndo($param['tgl_awal']).' s/d '.tanggalIndo($param['tgl_akhir']),0,0,'C');
...
$this->thoni_fpdf->SetWidths(array(1, 4, 6.5, 3, 3, 10));
$this->thoni_fpdf->SetAligns(array('C','C','C','C','C','L'));
...
$this->thoni_fpdf->SetWidths(array(11.5, 3,3));
$this->thoni_fpdf->SetAligns(array('C','R','R'));
$this->thoni_fpdf->Row(array('Total ', format_rupiah($tot_debit),format_rupiah($tot_kredit)));

$this->thoni_fpdf->SetWidths(array(11.5, 6));
$this->thoni_fpdf->SetAligns(array('C','C'));
$this->thoni_fpdf->Row(array($stat, format_rupiah(abs($total))));
...
$this->thoni_fpdf->Cell(15, 0.5, 'Created by : Atombizz.',0,'LR','L');
