    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-list"></i>&nbsp;Data Laba Rugi</div>
            </div>
            <div class="portlet-body form">
                <span id="flash_message"></span>
                <form id="form_gaji" class="horizontal-form" method="POST" action="<?php echo base_url($this->cname); ?>/pdf_rl" target="_blank">
                    <div class="form-body">
                    ...
                    <div class="form-actions right">
                        ...
                        <button type="button" onclick="exp_excel()" class="btn green" id="export_excel">Excel</button>
                    </div>
                </form>
            </div>
...
function list_debet(){
    ...
    var debet = $('#debet').val();
    var url = "<?php echo base_url($this->cname);?>/table_rl";
