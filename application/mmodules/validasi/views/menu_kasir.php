                ...
                <table class="table table-striped table-bordered table-hover" id="example-datatable">
                    <thead>
                        <tr>
                            ...
                            <th width="">Kode</th>
                            <th width="">Tanggal</th>
                            <th width="">Kas Awal</th>
                            <th width="">Omset</th>
                            <th width="">Total Cash</th>
                            <th width="">Kas Akhir</th>
                            <th width="">Selisih</th>
...
$(function(){
    ...
    */
    var oTable = $('#example-datatable').dataTable( {
        ...
        "bProcessing":true,
        "bServerSide":true,
        "sAjaxSource": "<?php echo base_url($this->module); ?>/_datatable/daftar_kasir",
...
function actDetail(object)
  {
      window.location="<?php echo base_url($this->cname).'/detail_kasir/'; ?>" + object;
  }

function actValidasi(Object){
    $('#id-validasi').val(Object);
    $('#modal-confirm').modal('show');
}
function validasi(){
   var id = $('#id-validasi').val();
   var url = '<?php echo base_url($this->module); ?>/validasi_kasir';
   $.ajax({
        type: "POST",
        url: url,
        data: {
